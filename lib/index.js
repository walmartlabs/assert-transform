...
module.exports = function (initial, expected, babelConfig) {
  return _bluebird2.default.props({
    actual: fs.readFileAsync(initial, "utf8").then(_lodash2.default.partialRight(_babelCore2.default.transform, babelConfig)).then(function (result) {
      return result.code;
    }).then(_lodash2.default.trim),
    expected: fs.readFileAsync(expected, "utf8").then(_lodash2.default.trim)
